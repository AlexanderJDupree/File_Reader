...
ifeq ($(config),release_posix_x64)
  RESCOMP = windres
  TARGETDIR = ../bin/Release/POSIX_x64
  TARGET = $(TARGETDIR)/libFileReader.a
...
$(OBJDIR)/file_reader.o: ../src/file_reader.c
	@echo $(notdir $<)
